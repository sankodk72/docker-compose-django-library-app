...
class Book(models.Model):
    ...
    author = models.ForeignKey('author.Author', on_delete=models.CASCADE, blank=True, null=True, related_name='authorof')
    slug_link = models.CharField(max_length=40, default='', blank=True)
